...
document.getElementById('yAxis-header').style.top = document.getElementsByClassName('container')[0].clientHeight-document.getElementById('scope-1').clientHeight+'px';
